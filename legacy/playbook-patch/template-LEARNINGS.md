...
- (e.g. fixed-bias sweep results, OOF→LB gap tracking, successful
  diversity sources, Jaccard-vs-lift data points)
...
- (e.g. what stop-conditions worked, how to budget LB submissions,
  signs that CV–LB divergence is diagnostic, gradient-discipline
