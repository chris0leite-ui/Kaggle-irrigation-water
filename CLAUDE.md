...
- Next: remaining Tier-A #A1 (Saerens-2002) already closed null on
  this branch — A0, A1, A2 all null. Remaining untried is B0
  DivideMix (mechanism-novel), C-tier isotonic + TTA + conformal,
  D-tier L1 zoo and model families (TabM, ModernNCA). Per
  NEXT_STEPS.md execution order, **C0 isotonic calibration** is the
  cheapest next step — was claimed as P5 by a parallel session and
