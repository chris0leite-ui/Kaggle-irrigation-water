...
Extends greedy_realmlp_refit.py by:
  * Adding new 3-class candidates: recipe_focal (g2h3), recipe_focal_invfreq
    (alpha=invfreq), soft_distill_small (d=3/r=1500),
    soft_distill_tiny (d=2/r=500), recipe_smote2x.
  * EXCLUDE_GREEDY_ADD for LB-verified regressors — valid as anchor
    ingredients but cannot be greedy-added:
      soft_distill, soft_distill_small, soft_distill_tiny,
      recipe_pseudolabel_stage2, xgb_spec_678,
      recipe_pseudolabel_seed7labeler, recipe_pseudolabel_seed123labeler.
  * Three anchors: recipe, lb_best_3way, lb_best_realmlp_stack.
...
LB_BEST_OOF = 0.98061  # RealMLP 3-stack blend (current verified LB-best 0.98008)
...
CANDIDATES = [
    ...
    "recipe_smote2x",
    "soft_distill_small", "soft_distill", "soft_distill_tiny",
