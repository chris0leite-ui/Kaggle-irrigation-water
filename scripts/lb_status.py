...
CLAUDE.md rule (added 2026-04-30): every LB-probe recommendation must
verify the candidate is NOT already in the submissions list. This script
is the single-line check.
"""
