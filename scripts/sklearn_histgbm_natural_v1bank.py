...
Outputs:
  scripts/artifacts/oof_sklearn_histgbm_natural_v1bank.npy
  scripts/artifacts/test_sklearn_histgbm_natural_v1bank.npy
  scripts/artifacts/sklearn_histgbm_natural_v1bank_results.json
"""
...
def main():
    ...
    hgb_params = dict(
        ...
        n_iter_no_change=50,
        random_state=SEED,
        class_weight=None,             # natural-cal
        verbose=0,
    )
    log(f"HistGBM (natural): max_iter={n_iter} max_depth={max_depth} "
        f"lr=0.05 l2_reg=0 class_weight=None")
    ...
    np.save(ART / "oof_sklearn_histgbm_natural_v1bank.npy", oof)
    np.save(ART / "test_sklearn_histgbm_natural_v1bank.npy", test_pred)
    ...
    with open(ART / "sklearn_histgbm_natural_v1bank_results.json", "w") as f:
        json.dump(summary, f, indent=2)
    log(f"wrote {ART}/sklearn_histgbm_natural_v1bank_results.json")
    ...
    sub_path = SUB / "submission_sklearn_histgbm_natural_v1bank_standalone.csv"
