...
for fold in range(1, N_FOLDS + 1):
    ...
    try:
        ...
        print(f"  LR FAILED ({type(e).__name__}: {str(e)[:200]}); leaving zeros", flush=True)
    ...
    try:
        ...
        print(f"  RF FAILED ({type(e).__name__}: {str(e)[:200]}); leaving zeros", flush=True)
    ...
    try:
        ...
        print(f"  KNN FAILED ({type(e).__name__}: {str(e)[:200]}); leaving zeros", flush=True)
